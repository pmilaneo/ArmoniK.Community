...
This page presents the full Contributor License Agreement (CLA) that will be asked to any code contributor. The version below is the most recent version as of the 23rd of June 2023.
You will be asked to sign the CLA when you submit your first pull request for ArmoniK. A link will be provided and if you follow it, you will be prompted to sign the CLA in just a few clicks. You must be authenticated with your Github account to sign the CLA.
...
Thank you for your interest in contributing to ANEO's ArmoniK ("We" or "Us").

The purpose of this contributor agreement ("Agreement") is to clarify and document the rights granted by contributors to Us. To make this document effective, please follow the [instructions](https://www.armonik.fr/contributions).
...
If You are an employee and have created the Contribution as part of your employment, You need to have Your employer approve this Agreement or sign the Entity version of this document. If You do not own the Copyright in the entire work of authorship, any other author of the Contribution should also sign this – in any event,  please contact Us at [armonik@aneo.fr](mailto:armonik@aneo.fr)
